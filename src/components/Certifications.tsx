...
export default function Certifications() {
  ...
  const certificates = [
    {
      ...
      image: 'https://raw.githubusercontent.com/adithyakr/revenueclues-assets/main/Revops%20certificate.png'
    },
    {
      title: 'HubSpot Reporting & Analytics Certified',
      image: 'https://raw.githubusercontent.com/adithyakr/revenueclues-assets/main/Hubspot%20reporting%20certificate.png'
    },
    {
      title: 'Product Analytics Certified (Product School)',
      image: 'https://raw.githubusercontent.com/adithyakr/revenueclues-assets/main/PA%20Certificate.png'
    }
  ];
  ...
  return (
    <section id="certifications" className="min-h-screen flex items-center justify-center bg-[#F9F9F9] py-20 snap-start">
